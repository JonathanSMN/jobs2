...
import 'convite_model.dart';
export 'convite_model.dart';

class ConviteWidget extends StatefulWidget {
  const ConviteWidget({Key? key}) : super(key: key);
...
class _ConviteWidgetState extends State<ConviteWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConviteModel());
