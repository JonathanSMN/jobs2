...
import 'aplicacoes_model.dart';
export 'aplicacoes_model.dart';

class AplicacoesWidget extends StatefulWidget {
  const AplicacoesWidget({Key? key}) : super(key: key);

  @override
  _AplicacoesWidgetState createState() => _AplicacoesWidgetState();
}

class _AplicacoesWidgetState extends State<AplicacoesWidget> {
  late AplicacoesModel _model;
